...
export const LANG_EN_TRANS = {
  ...
  'search-tip-1': 'Check your spelling and try again',
  'search-tip-2': 'Add space between your words',
  'search-tip-3': 'Use data provider name, aggregator name or data set id to search',
  setspec: 'Setspec',
  signin: 'Sign in',
  ...
  step: 'step',
  submit: 'Submit',
  'system time-out': 'System (after timeout)',
  ...
  'workflow-remove-link-check': 'Remove link check',
